...
#3ae1cd, lake #99cacd; leave unannotated pixels transparent or black. Nonzero
alpha counts as paint. Marks outside reference inland water are ignored. This
...
def main():
    ...
    for label, color in ((1, RIVER[0]), (2, LAKE[0])):
